...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'options', 'entourage', 'details', 'what-to-wear', 'rsvp', 'photos'];
    ...
    <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
      <div className="navbar-container">
        ...
        <ul className={`navbar-menu ${isOpen ? 'open' : ''}`}>
          ...
          <li><a href="#rsvp" onClick={handleNavClick} className={activeSection === 'rsvp' ? 'active' : ''}>RSVP</a></li>
